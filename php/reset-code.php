...
<html lang="en">
    <head>
        ...
        <!-- Webpage Title -->
        <title>Reset Code - Ninos.Finance</title>
              ...
              <div class="text-box mt-5 mb-5">
                <form action="reset-code.php" method="POST" autocomplete="off">
                    ...
                    <div class="mb-4 form-floating">
                        <input class="form-control" type="number" name="otp" id="floatingInputResetCode" placeholder="Enter code" required>
                        <label for="floatingInputResetCode">Enter Code</label>
                    </div>

                <button class="form-control-submit-button" type="submit" name="check-reset-otp" value="Submit">Reset Code</button>
