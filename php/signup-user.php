...
<html lang="en">
    <head>
        ...
        <!-- Webpage Title -->
        <title>Sign-up - Ninos.Finance</title>
            ...
            <div class="container">
                <div class="row">
                    ...
                    ?>
                                ...
                                <div class="mb-4 form-floating">
                                    <input type="name" type="text" class="form-control" id="floatingInput2" placeholder="Your name" required value="<?php echo $name ?>">
                                ...
                                <div class="mb-4 form-floating">
                                    <input name="cpassword" type="password" class="form-control" id="confirmPassword" placeholder=" Confirm Password">
                                ...
                                <button name="signup" value="signup" type="submit" class="form-control-submit-button">Sign up</button>
                            </form>
                            <!-- end of sign up form -->
