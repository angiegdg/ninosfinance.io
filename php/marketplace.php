...
<html lang="en">
  ...
  <body>
    ...
    <!-- OTC TOP Section -->
    <div class="otctop" id="home">
      <div class="otctop__container">
        <h1 class="otctop__heading">Coming <span>SOON</span></h1>
        <p class="otctop__description">Marketplace for Classified Ads, OTC trades, and NFTs.</p>
      </div>
    </div>
